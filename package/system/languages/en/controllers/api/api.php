...
define('LANG_API_ALLOW_METHODS', 'Allowed methods for this key');
define('LANG_API_DISALLOW_METHODS', 'Disallowed methods for this key');
...
define('LANG_API_STAT_ERRORS_HINT', 'Total errors');
define('LANG_API_STAT_ERRORS_HINT1', 'Without method');
...
define('LANG_API_ERROR7', 'Permission to perform this action is denied');
define('LANG_API_ERROR71', 'User authorization required');
define('LANG_API_ERROR710', 'Administrative access requires');
...
define('LANG_API_ERROR24', 'This method is not available');
...
define('LANG_API_ERROR777', 'Invalid user ip');
define('LANG_API_ERROR778', 'Item not found');
define('LANG_API_ERROR_CSRF_TOKEN', 'Error csrf token. The token is not passed or is not correct.');
