...
define('LANG_API_ALLOW_ADMIN_LOGIN', 'Разрешить авторизацию администраторам');
...
define('LANG_API_ERROR710', 'Требуется административный доступ');
...
define('LANG_API_ERROR778', 'Запись не найдена');
